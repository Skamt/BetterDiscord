...
class MenuPatcher {
	...
	static patchRecursive(target, method, iteration = 0) {
		...
		const proxyFunction =
			this.subPatches.get(target[method]) ??
			(() => {
